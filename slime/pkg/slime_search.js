 ...
 * @returns {Uint8Array}
 */
export function get_slime_bitmap(seed_hi, seed_lo, cx_min, cz_min, width, height) {
    const ret = wasm.get_slime_bitmap(seed_hi, seed_lo, cx_min, cz_min, width, height);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('slime_search_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
